...
public class AdminDashboardController {
    ...
    public ResponseEntity<?> getDashboardOverview() {
        try {
            ...
            userStats.put("totalStudents", userRepository.countByRole(UserRole.STUDENT));
            userStats.put("totalTutors", userRepository.countByRole(UserRole.TUTOR));
            // userStats.put("activeUsers", userRepository.countByEnabled(true)); // enabled field removed
            ...
            bookingStats.put("completedBookings", bookingRepository.countByStatus(BookingStatus.TUTOR_ACCEPTED));
            ...
            paymentStats.put("completedPayments", paymentRepository.countByStatus(PaymentStatus.COMPLETED));
            paymentStats.put("pendingPayments", paymentRepository.countByStatus(PaymentStatus.PENDING));
            ...
            couponStats.put("activeCoupons", couponRepository.countByStatus(CouponStatus.ACTIVE));
