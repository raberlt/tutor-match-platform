...
public class AdminCouponController {
    ...
    public ResponseEntity<?> getAllCoupons(
        ...
        try {
            ...
            if (status != null && !status.trim().isEmpty()) {
                ...
                try {
                    BookingType bookingType = BookingType.valueOf(applicableBookingType.toUpperCase());
    ...
    public ResponseEntity<?> createCoupon(@RequestBody CouponDTO couponDTO, Authentication authentication) {
        try {
            ...
            Optional<Coupon> existingCoupon = couponRepository.findByCodeAndStatus(couponDTO.getCode(), CouponStatus.ACTIVE);
    ...
    private Coupon convertDTOToCoupon(CouponDTO dto) {
        ...
        if (dto.getStartDate() != null) {
            coupon.setStartDate(LocalDate.parse(dto.getStartDate()));
        }
        if (dto.getEndDate() != null) {
            coupon.setEndDate(LocalDate.parse(dto.getEndDate()));
        }
        ...
        if (dto.getApplicableBookingType() != null) {
            coupon.setApplicableBookingType(BookingType.valueOf(dto.getApplicableBookingType()));
        }
    ...
    private void updateCouponFromDTO(Coupon coupon, CouponDTO dto) {
        ...
        if (dto.getStartDate() != null) coupon.setStartDate(LocalDate.parse(dto.getStartDate()));
        if (dto.getEndDate() != null) coupon.setEndDate(LocalDate.parse(dto.getEndDate()));
