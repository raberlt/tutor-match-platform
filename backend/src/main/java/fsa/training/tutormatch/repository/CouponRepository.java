...
public interface CouponRepository extends JpaRepository<Coupon, Integer> {
    ...
    Optional<Coupon> findValidCoupon(@Param("code") String code, @Param("currentDate") LocalDate currentDate);
    
    List<Coupon> findByApplicableBookingType(BookingType bookingType);
    
    Page<Coupon> findByApplicableBookingType(BookingType bookingType, Pageable pageable);
