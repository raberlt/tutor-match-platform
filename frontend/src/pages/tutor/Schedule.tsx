          ...
          >
            {["week", "month", "day"].map((mode) => (
              <button
                ...
                style={{
                  backgroundColor:
                    viewMode === mode ? "rgb(148, 204, 230)" : "transparent",
                }}
              >
            ...
            <div className="grid grid-cols-8">
              {timeSlots.map((time, timeIndex) => (
                <React.Fragment key={timeIndex}>
                  <div
                    className="p-2 text-center text-sm border-b border-r"
                    style={{
                  ...
                  {weekDays.map((day, dayIndex) => {
                    ...
                    return (
                      <div
                        key={dayIndex}
                        className="p-1 border-b border-l min-h-[60px] relative"
                        style={{ borderColor: "rgba(148, 204, 230, 0.2)" }}
                      >
                        {eventsAtTime.map((event) => (
                          <div
                            ...
                            className="absolute inset-x-1 top-1 p-2 rounded-xl text-xs cursor-pointer hover:shadow-md transition-shadow"
                            style={{
                              height: `${Math.max(
                                40,
                              ...
                              backgroundColor:
                                event.type === "online"
                                  ? "rgba(148, 204, 230, 0.1)"
                                  : "rgba(148, 204, 230, 0.2)",
                              borderLeft: "4px solid rgb(148, 204, 230)",
                            }}
                          >
